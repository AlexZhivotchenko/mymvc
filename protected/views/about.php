			...
			<div id="header">
				...
				<div id="menu">
					<ul>
						...
						<li><a href="/user/89">Профиль</a></li>
					</ul>
					<br class="clearfix" />
				</div>
			</div>
			<div id="page">
				...
				<div id="content">
					<div class="box">
						...
						<img class="alignleft" src="images/pic03.jpg" width="200" height="180" alt="" />
						<p>
						   <?php
							  echo $about;
							?>
						<br/>
							Курсы по php. Ученик Животченко Алексей Владимирович.
						</p>
